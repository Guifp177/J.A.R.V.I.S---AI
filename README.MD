...
PT-BR:
=========================================
Assistente inteligente local inspirado no J.A.R.V.I.S., desenvolvido em Python, com interface gráfica, voz opcional, microfone, memória persistente e integração com Ollama (Cloud Free/Paga ou Local).
